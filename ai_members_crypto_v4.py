        ...
        with tab5:
            ...
            if market_mode == "Crypto":
                ...
                if crypto_filtered.empty:
                    ...
                    st.dataframe(
                        crypto_filtered[[col_symbol, name_col, col_price, change_col, score_col, col_trend, "RSI", "Funding Rate", "Bybit 多空比" if lang == "zh" else "Bybit Long/Short", pattern_col, screen_reason_col]],
                        width="stretch",
                        hide_index=True
                    )
            else:
